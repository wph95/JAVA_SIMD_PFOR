...
public class MultiCodeC {
    ...
    public static void main(String args[]) throws FileNotFoundException {
        int[][] data = createData();
        testCodec(new Composition(new SIMDBinaryPacking(), new VariableByte()), data, 100, true);
        testCodec(new Composition(new BinaryPacking(), new VariableByte()), data, 100, true);
    }
